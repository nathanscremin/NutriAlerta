...
5. Clique em **Deploy**. A Vercel compilará a aplicação e gerará uma URL criptografada HTTPS gratuita (exemplo: `https://nutri-alerta.vercel.app`).

---

## 🏫 Passo 3: Hospedar o Portal de Pesagem Escolar (Projeto Vercel 2)

O segundo projeto hospedará a interface do portal coletor escolar (**Nutri-for-Schools**), onde as escolas registram a pesagem e exames antropométricos dos alunos de forma 100% anônima:
