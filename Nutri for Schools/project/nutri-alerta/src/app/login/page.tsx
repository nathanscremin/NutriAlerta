      ...
      >
        ...
        <div className="flex flex-col items-center mb-6">
          ...
          <h1 className="text-2xl font-black tracking-tight text-white flex items-center gap-1.5">
            Nutri <span className="text-teal-400 font-apple-cursive text-2xl tracking-wide select-none">for Schools</span>
          </h1>
        ...
        <div className="mt-8 text-center text-[10px] text-zinc-500 border-t border-zinc-800/50 pt-4">
          Acesso exclusivo para diretores e secretários cadastrados da rede municipal.
        </div>
      </motion.div>
    </div>
  );
